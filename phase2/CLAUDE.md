...
1. **auth-agent**: For authentication implementation using Better Auth
2. **fastapi-backend-expert**: For FastAPI development and API endpoint creation
3. **neon-db-engineer**: For database designs and operations with Neon Serverless PostgreSQL
4. **responsive-ui-integrator**: For frontend development (e.g., Next.js responsive interfaces)
